  ...
  const PublicVsAccount = () => {
    ...
    return (<div>
      ...
      <Sec title="What This Means">
        ...
        <Insight><strong>Two audiences, two entry points.</strong> For formation, the account outperforms or matches the public site — users sign up because the Navigator adds real value. For post-formation topics, the public site gets 7x–400x more traffic than the account equivalents. We don't have per-page channel data to know exactly how users reach these public pages (organic search, paid ads, internal navigation, referrals), but the pattern is clear: post-formation content is being consumed overwhelmingly outside the account. The question is whether the account wall is helping or hindering for this content.</Insight>
      </Sec>
    </div>);
  };
